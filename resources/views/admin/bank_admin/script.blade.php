    ...
    <script>
        $(function() {
            ...
            window.editCustomer = function(id) {
                $.ajax({
                    type: 'GET',
                    url: '/bank/edit-admin/' + id,
                    success: function(response) {
                        $('#formBankId').val(response.id);
                        $('#formIdBank').val(response.id_bank);
                        $('#formNama').val(response.nama);
                        $('#formNoRek').val(response.no_rek);
